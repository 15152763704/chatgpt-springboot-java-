    ...
    if(!that.data.userInfo.avatar){
      ...
      wx.getUserProfile({
        ...
        success: (userInfoRes) => {
          ...
          that.data.userInfo.avatar = userInfoRes.userInfo.avatarUrl
          that.data.userInfo.nickName = userInfoRes.userInfo.nickName
          wx.request({
            url:  app.globalData.ip +'/wx/updateWxxcxUserInfo',
            method: 'post',
        ...
        complete:(userProfileCompleteRes) => {
          console.log(userProfileCompleteRes)
        }
      })
    }else{
      that.sendData()
      ...
      wx.getStorage({
        ...
        success (res) {
          wx.request({
            ...
            success: function(res) {
              that.data.messageList.push(res.data.data)
              if(res.data.data){
